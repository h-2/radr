...
//!\brief The same as std::indirectly_unary_invocable, but only requires move-construction instead of copy_construction.
template< class F, class I>
concept weak_indirectly_unary_invocable =
