...
class repeat_rng : public range_interface<repeat_rng<TVal, Bound, storage>>
{
...
public:
    ...
    using range_interface<repeat_rng<TVal, Bound, storage>>::empty;
    ...
    using range_interface<repeat_rng<TVal, Bound, storage>>::size;
