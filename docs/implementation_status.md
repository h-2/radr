...
| `radr::adjacent_transform<N>(fn)` | C++20     | | `std::views::adjacent_transform` | **C++23** |                                          |
...
| `radr::pairwise_transform(fn)`    | C++20     | | `std::views::pairwise_transform` | **C++23** |                                          |
...
| `radr::zip_with_transform(fn, w)` | C++20     | | `std::views::zip_transform`      | **C++23** | see also `radr::zip_transform()` below   |
...
| `radr::zip_transform(fn, v, w)` | C++20     | | `std::views::zip_transform` | **C++23** | thin wrapper around `radr::zip_with_transform` |

The standard library groups `counted`, `zip` and `zip_transform` with "range adaptors" and not "range factories".
