...
{
    int i = 3;
    EXPECT_SAME_TYPE(decltype(radr::single(std::ref(i))), (radr::single<int, radr::single_storage::indirect>));

    EXPECT_SAME_TYPE(decltype(radr::single(std::vector{3})),
                     (radr::single<std::vector<int>, radr::single_storage::in_range>));

    EXPECT_SAME_TYPE(decltype(radr::single(3)), (radr::single<int const, radr::single_storage::in_iterator>));
}
...
{
    using R = radr::single<int, radr::single_storage::indirect>;
...
{
    using C = radr::single<int const, radr::single_storage::indirect>;
...
{
    int                                               i = 3;
    radr::single<int, radr::single_storage::indirect> r{i};
    EXPECT_EQ(*r.begin(), 3);
    EXPECT_EQ(*r.data(), 3);
...
{
    int                                                     i = 3;
    radr::single<int const, radr::single_storage::indirect> c{i};
    EXPECT_EQ(*c.begin(), 3);
    EXPECT_EQ(*c.data(), 3);
...
{
    radr::single<int, radr::single_storage::indirect> r{};
...
{
    radr::single<int const, radr::single_storage::indirect> c{};
...
{
    using R = radr::single<int, radr::single_storage::in_range>;
    EXPECT_TRUE(std::ranges::contiguous_range<R>);
...
{
    using C = radr::single<int const, radr::single_storage::in_range>;
    EXPECT_TRUE(std::ranges::contiguous_range<C>);
...
{
    radr::single<int, radr::single_storage::in_range> r{3};
    EXPECT_EQ(*r.begin(), 3);
    EXPECT_EQ(*r.data(), 3);
    EXPECT_EQ(r.size(), 1ull);
    EXPECT_EQ(r.empty(), false);
...
{
    radr::single<int const, radr::single_storage::in_range> c{3};
    EXPECT_EQ(*c.begin(), 3);
    EXPECT_EQ(*c.data(), 3);
    EXPECT_EQ(c.size(), 1ull);
    EXPECT_EQ(c.empty(), false);
...
{
    radr::single<int, radr::single_storage::in_range> r{};
...
{
    radr::single<int const, radr::single_storage::in_range> c{};
...
{
    using R = radr::single<int, radr::single_storage::in_iterator>;
...
{
    using C = radr::single<int const, radr::single_storage::in_iterator>;
...
{
    radr::single<int, radr::single_storage::in_iterator> r{3};
    EXPECT_EQ(*r.begin(), 3);
    EXPECT_EQ(r.size(), 1ull);
    EXPECT_EQ(r.empty(), false);
}
...
{
    radr::single<int const, radr::single_storage::in_iterator> c{3};
    EXPECT_EQ(*c.begin(), 3);
    EXPECT_EQ(c.size(), 1ull);
    EXPECT_EQ(c.empty(), false);
}
...
{
    radr::single<int, radr::single_storage::in_iterator> r{};
...
{
    radr::single<int const, radr::single_storage::in_iterator> c{};
